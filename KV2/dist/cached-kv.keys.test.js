...
describe("KV2 prefix option", () => {
    it("prepends global prefix to all keys", async () => {
        ...
        const result = await prefixedKv.get("key");
    ...
    it("isolates keys between different prefixes", async () => {
        const prefix1 = `${uniqueTestPrefix()}app1/`;
        const prefix2 = `${uniqueTestPrefix()}app2/`;
        ...
        const result1 = await kv1.get("shared-key");
...
//# sourceMappingURL=cached-kv.keys.test.js.map