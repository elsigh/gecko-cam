import { createBlob, hasPayload, isPureJsonFormat, parseBlob, parseHeader, } from "./blob-format.js";
...
describe("blob-format", () => {
    ...
    describe("parseBlob error handling", () => {
        it("throws on empty buffer", () => {
            expect(() => parseBlob(Buffer.alloc(0))).toThrow("Cannot parse empty buffer");
        });
...
//# sourceMappingURL=blob-format.test.js.map